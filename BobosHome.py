...
@app.route("/championshipdna-bangkok.jpg")
def championshipdna_bangkok_img():
    return send_from_directory(os.path.dirname(__file__), "ChampionshipDNABangkok.jpg", mimetype="image/jpeg")
