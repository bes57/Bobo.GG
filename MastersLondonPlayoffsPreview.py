...
<style>
  ...
  .rs-chart-title { font-family:'Syne',sans-serif; font-size:1.1rem; font-weight:800; text-transform:uppercase; letter-spacing:.02em; color:var(--ink); text-align:center; margin-bottom:10px; }
  ...
  .br-side-label { font-family:'Syne',sans-serif; font-size:.82rem; font-weight:800; letter-spacing:.06em; text-transform:uppercase; color:var(--ink); margin:4px 0 8px; }
  ...
  .br-round-label { font-family:'Syne',sans-serif; font-size:.58rem; font-weight:800; letter-spacing:.08em; text-transform:uppercase; color:var(--soft); text-align:center; margin-bottom:8px; height:13px; }
  ...
  .mc-team-name { font-family:'Syne',sans-serif; font-weight:800; font-size:.78rem; }
  .mc-prob { flex:1; min-width:0; }
  .mc-prob-pcts { display:flex; justify-content:space-between; gap:10px; font-family:'Syne',sans-serif; font-weight:800; font-size:.92rem; color:var(--soft); white-space:nowrap; }
  ...
  .mc-sec-lbl { font-family:'Syne',sans-serif; font-size:.56rem; font-weight:800; text-transform:uppercase; letter-spacing:.07em; color:var(--soft); margin:9px 0 5px; }
  ...
  .mc-veto-tag { margin-left:auto; font-family:'Syne',sans-serif; font-size:.52rem; font-weight:800; text-transform:uppercase; letter-spacing:.03em; padding:2px 6px; border-radius:5px; white-space:nowrap; }
  ...
  .br-team .br-tag { margin-left:auto; font-family:'Syne',sans-serif; font-size:.52rem; font-weight:800; letter-spacing:.05em; color:#7c3aed; }
  ...
  .my-pred-head { font-family:'Syne',sans-serif; font-size:1.3rem; font-weight:800; letter-spacing:-.5px; color:var(--ink); margin:30px 0 4px; }
  ...
  #rsPopup .popup-score{font-size:1.9rem;font-weight:800;font-family:'Syne',sans-serif;line-height:1}
  ...
  .benpom-pop-links a { display:block; font-family:'Syne',sans-serif; font-size:.72rem; font-weight:800; letter-spacing:.03em; color:#7c3aed; text-decoration:none; padding:8px 10px; border-radius:9px; background:#f5eefe; transition:background .15s; }
...
<div class="page">
  <div class="article">
    ...
    <h1>Masters London: Playoffs Preview</h1>
