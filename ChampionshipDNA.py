...
<div class="page">
  <div class="article">
    ...
    <div class="content">
      ...
      <p>This is also extremely interesting. &frac13; of the winning teams had the highest-rated player in the previous domestic split. Also, T1 at Bangkok are again an exception to the rule. Their highest-rated player (Buzz) was ranked 18th in Pacific Kickoff 2025. The second-lowest rank was 6th for RB with Nongshim in 2026. This article is just turning into <em>&ldquo;T1 winning Bangkok is a gigantic statistical and historical anomaly&rdquo;</em>, but I digress.</p>
