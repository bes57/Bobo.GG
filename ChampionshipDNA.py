  ...
  <div class="article">
    ...
    <div class="content">
      ...
      <ul class="notes">
        ...
        <li>Speaking of random, We can also see which teams overshot their previous domestic performance! <a class="pin" data-org="T1" data-intl="Masters Bangkok 2025">T1 at Bangkok</a> is the most obvious one. Here&rsquo;s a map of all of the teams coming into Masters Bangkok on this graph:
